...
- **LTS (Long-Term Support) versions**: `4.0.x`, `4.2.x`, `4.6.x`, `4.10.x`, `4.14.x` - Recommended for production environments
- **Non-LTS (Short-term) versions**: `4.1.x`, `4.3.x`, `4.5.x`, `4.7.x`, `4.8.x`, `4.11.x`, `4.12.x`, `4.15.x` - For early feature access
- **Release sequencing note**: `v4.9` and `v4.13` are intentionally skipped. The next release after `v4.8` is `v4.10 (LTS)`, and the next release after `v4.12` is `v4.14 (LTS)`.
...
## Upgrade Paths
### `Alauda DevOps Pipelines` v4.15

The table below contains the upgrade paths covered by this release's regression testing.

| Channel version | ACP version | Kubernetes version |
| :-------------: | :---------: | :----------------: |
|  pipelines-4.0  |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
|                 |     4.3     |        1.34        |
|  pipelines-4.2  |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
| pipelines-4.10  |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
|                 |     4.3     |        1.34        |

:::note
`pipelines-4.6`, `pipelines-4.12`, and `pipelines-4.14` are still within their maintenance period when `v4.15.0` ships, and upgrading from them to `v4.15.x` is supported as well: `4.6.x (LTS)` and `4.14.x (LTS)` through the LTS upgrade paths, and the non-LTS `4.12.x` through the maintenance path. They are not listed in the table above because they were not part of this release's upgrade regression. See [Upgrade Path Guidelines](#upgrade-path-guidelines) for the testing status that applies to each path.
:::

### `Alauda DevOps Pipelines` v4.14
...
:::note
`pipelines-4.6`, `pipelines-4.11`, and `pipelines-4.12` are still within their maintenance period when `v4.14.0` ships, and upgrading from them to `v4.14.x` is supported as well: `4.6.x (LTS)` through the LTS-to-LTS extended path, and the non-LTS `4.11.x` and `4.12.x` through the maintenance path. They are not listed in the table above because they were not part of this release's upgrade regression. See [Upgrade Path Guidelines](#upgrade-path-guidelines) for the testing status that applies to each path.
:::

### `Alauda DevOps Pipelines` v4.12

The table below contains the complete upgrade path.
...
|  pipelines-4.2  |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
|  pipelines-4.6  |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
| pipelines-4.10  |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
|                 |     4.3     |        1.34        |
| pipelines-4.11  |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
|                 |     4.3     |        1.34        |

### `Alauda DevOps Pipelines` v4.11
...
| Channel version | ACP version | Kubernetes version |
| :-------------: | :---------: | :----------------: |
|  pipelines-4.0  |     4.0     |        1.31        |
|                 |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
|                 |     4.3     |        1.34        |
|  pipelines-4.2  |     4.0     |        1.31        |
|                 |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
|  pipelines-4.6  |     4.0     |        1.31        |
|                 |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
|  pipelines-4.7  |     4.0     |        1.31        |
|                 |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
|  pipelines-4.8  |     4.0     |        1.31        |
|                 |     4.1     |        1.32        |
|                 |     4.2     |        1.33        |
...
| Channel version | ACP version | Kubernetes version |
| :-------------: | :---------: | :----------------: |
|  pipelines-4.0  |     4.0     |      1.31.12       |
|                 |     4.1     |       1.32.7       |
|  pipelines-4.2  |     4.0     |      1.31.12       |
|                 |     4.1     |       1.32.7       |
|  pipelines-4.6  |     4.0     |      1.31.12       |
|                 |     4.1     |       1.32.7       |
|                 |     4.2     |       1.33.6       |
|  pipelines-4.7  |     4.0     |      1.31.12       |
|                 |     4.1     |       1.32.7       |
|                 |     4.2     |       1.33.6       |
...
|  pipelines-4.2  |     4.0     |      1.31.12       |
|                 |     4.1     |       1.32.7       |
|  pipelines-4.3  |     4.0     |      1.31.12       |
|                 |     4.1     |       1.32.7       |
|  pipelines-4.4  |     4.0     |      1.31.12       |
|                 |     4.1     |       1.32.7       |
|  pipelines-4.6  |     4.0     |      1.31.12       |
|                 |     4.1     |       1.32.7       |
|                 |     4.2     |       1.33.6       |
...
This upgrade path has been tested with `Alauda DevOps Pipelines` Operator version v4.4.0 and ACP version 4.0.5, 4.1.2 (the latest LTS patch version available during testing)

| Channel version | ACP version | Kubernetes version |
|:---------------:|:-----------:|:------------------:|
| pipelines-4.0 | 4.0.5 | 1.31.12 |
|               | 4.1.2 | 1.32.7 |
| pipelines-4.1 | 4.0.5 | 1.31.12 |
|               | 4.1.2 | 1.32.7 |
| pipelines-4.2 | 4.0.5 | 1.31.12 |
|               | 4.1.2 | 1.32.7 |
| pipelines-4.3 | 4.0.5 | 1.31.12 |
|               | 4.1.2 | 1.32.7 |

### `Alauda DevOps Pipelines` v4.3.0

This upgrade path has been tested with `Alauda DevOps Pipelines` Operator version v4.3.0 and ACP version 4.0.4, 4.1.1 (the latest LTS patch version available during testing)

| Channel version | ACP version | Kubernetes version |
|:---------------:|:-----------:|:------------------:|
| pipelines-4.0 | 4.0.4 | 1.31.6 |
|               | 4.1.1 | 1.32.7 |
| pipelines-4.1 | 4.0.4 | 1.31.6 |
|               | 4.1.1 | 1.32.7 |
| pipelines-4.2 | 4.0.4 | 1.31.6 |
|               | 4.1.1 | 1.32.7 |

### `Alauda DevOps Pipelines` v4.2.0

This upgrade path has been tested with `Alauda DevOps Pipelines` Operator version v4.2.0 and ACP version 4.0.3, 4.1.0 (the latest LTS patch version available during testing)

| Channel version | ACP version | Kubernetes version |
|:---------------:|:-----------:|:------------------:|
| pipelines-4.0 | 4.0.3 | 1.31.6 |
|               | 4.1.0 | 1.32.7 |
| pipelines-4.1 | 4.0.3 | 1.31.6 |
|               | 4.1.0 | 1.32.7 |
...
## Upgrade Path Guidelines \{#upgrade-path-guidelines}
...
- **Primary Path**: **Previous LTS → Current non-LTS**
  ...
  - *Testing Status*: All patch versions tested; latest patch versions receive comprehensive regression testing.
  - *Example*: `4.10.x (LTS)` → `4.12.x (non-LTS)`

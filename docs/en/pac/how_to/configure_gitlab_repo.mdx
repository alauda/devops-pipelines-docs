...
- **Format**: `https://gitlab.com/username/repo.git` or `git@gitlab.com:username/repo.git`
...
### Example Interactive Session
    ...
    ```
    ? Enter the Git repository URL: https://gitlab.com/myuser/myproject.git
...
Example output:
    ...
    project-pipelines  my-repo    https://gitlab.com/user/repo.git       2m
    ```
...
Example output:
    ...
    ```
    NAME       URL                                    AGE
    my-repo    https://gitlab.com/user/repo.git       2m
    ```
...
Verify the secret was created:
    ...
    ```bash
    kubectl get secrets -n <your-namespace> | grep pipelines-as-code
    ```
...
Example output:
    ...
    ```
    NAME                          TYPE     DATA   AGE
    pipelines-as-code-secret     Opaque   2      2m
    ```

View secret details (base64 encoded):

First, get the secret name from the list above, then view details:

    ```bash
    kubectl get secret <secret-name> -n <your-namespace> -o yaml
    ```

Replace `<secret-name>` with the actual secret name from the list (e.g., `pipelines-as-code-secret`).

Example output (abbreviated, values are base64 encoded):
...
Create a file `repository.yaml`:
    ...
    metadata:
      ...
      namespace: project-pipelines
    spec:
      url: "https://gitlab.com/myuser/myproject.git"
      git_provider:
        type: gitlab
        url: "https://gitlab.com"
        secret:

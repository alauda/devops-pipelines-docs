...
- **Resolver integration** — pull tasks from the DevOps Hub catalog served by `artifacthub-shim`, remote Git URLs, or other resolvers without bundling them in the repository.

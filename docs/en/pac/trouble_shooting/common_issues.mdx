...
|---|---|---|
| `WebhookURLUnavailable` | The controller cannot find the public PAC webhook URL. | Populate `pipelines-as-code-info.data.controller-url` through `OpenShiftPipelinesAsCode` or `TektonConfig`. |

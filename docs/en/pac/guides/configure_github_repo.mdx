...
Add a PipelineRun manifest under `.tekton/` in the repository and push it. PAC will pick the event up and create a `PipelineRun` in the namespace. See [Define PipelineRuns in Git](../how_to/maintain_pipeline_code.mdx) for the file layout and the annotation grammar, and [Trigger Pipelines](../how_to/trigger_pipeline.mdx) for the Git operations that PAC reacts to.
...
Same as the App mode: add a PipelineRun under `.tekton/` in the repository. See [Define PipelineRuns in Git](../how_to/maintain_pipeline_code.mdx) and [Trigger Pipelines](../how_to/trigger_pipeline.mdx).
...
- [Trigger Pipelines](../how_to/trigger_pipeline.mdx) — push, pull request and comment-driven triggers.

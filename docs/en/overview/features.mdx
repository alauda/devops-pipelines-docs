...
- Tekton Hub Integration
  ...
  Access to a catalog of reusable Tasks and Pipelines to accelerate development. Starting from `v4.12.0`, the built-in `Tekton Hub` is not deployed by default and can be enabled on demand.

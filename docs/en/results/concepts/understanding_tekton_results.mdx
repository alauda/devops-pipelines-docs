...
| `maxRetention` | (Deprecated) Maximum time to keep data | `720h` (30 days) | (Deprecated) Duration to retain data before deletion |
| `defaultRetention` | Maximum time to keep data | `720h` (30 days) | Duration to retain data before deletion |

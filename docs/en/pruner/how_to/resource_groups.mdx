...
- [Namespace Configuration](./namespace_configuration) - Set up namespace ConfigMaps
- [Time-based Pruning](./time_based_pruning) - TTL strategies for groups
- [History-based Pruning](./history_based_pruning) - Retention strategies for groups

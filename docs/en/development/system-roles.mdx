...
The system roles are now integrated into the operator bundle during the build process. The bundle preparation script `.tekton/scripts/prepare-bundle.sh` (`copy_system_roles`) copies them into the bundle manifests:

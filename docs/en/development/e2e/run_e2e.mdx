...
> **Note**: The test image is built from the Containerfile located at `.tekton/containerfiles/operator-e2e.Containerfile`.
...
toolchains:
  ...
  harbor:
    ...
    registryConfig: <BASE64_ENCODED_REGISTRY_CONFIG>
...
**Harbor**:
- `registryConfig`: Base64 encoded distribution registry configuration file

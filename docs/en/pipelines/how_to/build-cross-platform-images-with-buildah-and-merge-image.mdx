...
i18n:
  title:
    en: Build Cross-Platform Images with Buildah and Merge-Image
    zh: 使用 Buildah 和 Merge-Image 构建跨平台镜像
title: Build Cross-Platform Images with Buildah and Merge-Image
---

...
i18n:
  title:
    en: Adjust Containerfile for Building Task-Compatible Custom Images
    zh: 调整 Containerfile 构建适用于 Task 的自定义镜像
title: Adjust Containerfile for Building Task-Compatible Custom Images
---
...
- You have a basic understanding of Containerfile writing
  - You can refer to the [Containerfile Official Documentation](https://docs.docker.com/get-started/docker-concepts/building-images/writing-a-dockerfile/)
  - Understand [Containerfile Best Practices](https://docs.docker.com/build/building/best-practices/)
...
- [Containerfile Official Documentation](https://docs.docker.com/get-started/docker-concepts/building-images/writing-a-dockerfile/)
- [Containerfile Best Practices](https://docs.docker.com/build/building/best-practices/)

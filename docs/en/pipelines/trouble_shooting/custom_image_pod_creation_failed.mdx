...
Refer to <ExternalSiteLink name="artifacthub-shim" href="/catalog/task-image-compatibility.html" children="Task Image Compatibility" /> to modify the Containerfile configuration for catalog Task usage.
...
- [Official Containerfile Documentation](https://docs.docker.com/get-started/docker-concepts/building-images/writing-a-dockerfile/)

...
Refer to [Adjust Containerfile for Task-Compatible Custom Images](../how_to/adjust_containerfile_for_task_compatible_image.mdx) to modify the Containerfile configuration.
...
- [Adjust Containerfile for Task-Compatible Custom Images](../how_to/adjust_containerfile_for_task_compatible_image.mdx)

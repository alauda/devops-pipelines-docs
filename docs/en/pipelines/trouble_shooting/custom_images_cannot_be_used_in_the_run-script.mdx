...
1. Refer to the document on [Adjusting Containerfile for Task-Compatible Custom Images](../how_to/adjust_containerfile_for_task_compatible_image.mdx) to modify the Containerfile configuration.
...
- [Adjusting Containerfile for Task-Compatible Custom Images](../how_to/adjust_containerfile_for_task_compatible_image.mdx)
